...
# Define infiles
feature_name_file = "intermediate/carbon_metabolism_feature_names.no_cyano.txt"
accession_id_file = "intermediate/carbon_metabolism_accession_ids.no_cyano.txt"
X_file            = "intermediate/carbon_metabolism_X.no_cyano.csv.gz"
y_file            = "intermediate/carbon_metabolism_y.no_cyano.txt"
...
outfile = open(
    "results/carbon_metabolism.feature_importance.no_cyano.tab", "w"
)
...
outfile = open(
    "results/carbon_metabolism.accession_accuracy_n.no_cyano.tab", "w"
)
